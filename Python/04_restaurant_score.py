...
Run from the repository root. The score is descriptive prioritization, not
profitability, revenue or a causal model.
"""
...
OUTPUT = ROOT / "Data" / "processed" / "restaurant_scores.csv"
